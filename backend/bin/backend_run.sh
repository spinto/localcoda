...
check_env VIRT_ENGINE IMAGES_${VIRT_ENGINE^^}_MAPFILE EXT_MAINHOST EXT_PROXYHOST TUTORIAL_MAX_TIME ORCHESTRATION_ENGINE INT_BASEPATH_SCHEME EXECUTION_NAME_SCHEME REMOTE_PORT 
